...
CNF_Finalise(void)
{
  ...
  logdir = NULL;
  bind_cmd_path = NULL;
  ntp_signd_socket = NULL;
  pidfile = NULL;
  rtc_device = NULL;
  rtc_file = NULL;
  user = NULL;
  mail_user_on_change = NULL;
  tempcomp_sensor_file = NULL;
...
parse_hwtimestamp(char *line)
{
  ...
  printf("QoTSyncService: Ignoring chrony config hw timestamping option in non-priveleged mode\n");
  return;
  #endif
  ...
  #ifdef NTP_QOT_STACK
  printf("QoTSyncService: Checking hardware timestamping options\n");
  #endif
